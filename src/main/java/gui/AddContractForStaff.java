...
public class AddContractForStaff extends JDialog {

    private static final long serialVersionUID = 1L;
    private static AddContractForStaff instance;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                AddContractForStaff frame = new AddContractForStaff();
	...
	public AddContractForStaff() {
        ...
        lblId_7 = new JLabel("Apartment ID");
        ...
        panel_11.add(textFieldApartmentId);
        ...
        btnNewButton = new JButton(null,iconAdd);
        btnNewButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		btnNewButtonActionPerformed(e);
        	}
        });
        btnNewButton.setBounds(143, 0, 25, 25);
        ...
        lblNewLabel_1.setBounds(29, 452, 124, 14);
        contentPane.add(lblNewLabel_1);
        
        fillData();
    }

    public static AddContractForStaff getInstance() {
        if (instance == null) {
            instance = new AddContractForStaff();
        }
        return instance;
    }
	...
	public void loadData() {
    	...
    	textFieldApartmentType.setText(apartmentType.getType());
    	textFieldApartmentPrice.setText(apartmentType.getPrice().toString());
	...
	protected void btnAddActionPerformed(ActionEvent e) {
		...
		contract.setApartmentId(textFieldApartmentId.getText());
		...
		if(isSuccess) {
		    ...
		    ApartmentDAO apartmentDAO = new ApartmentDAO();
		    apartmentDAO.updateApartmentStatusToOccupied(textFieldApartmentId.getText(), comboBoxHouseholdIdNumber.getSelectedItem().toString());
