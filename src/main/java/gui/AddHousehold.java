...
public class AddHousehold extends JDialog {

    private static final long serialVersionUID = 1L;
    private static AddHousehold instance;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                AddHousehold frame = new AddHousehold();
	...
	public AddHousehold() {
        ...
        lblNewLabel = new JLabel("<html>ID Number <font color='red'>(*)</font></html>");
        lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 13));
        lblNewLabel.setBounds(33, 37, 105, 16);
        ...
        lblPrice.setBounds(33, 90, 105, 16);
        panel.add(lblPrice);
        ...
        lblIdNumber.setBounds(326, 143, 150, 16);
        ...
        textFieldMemberQuantity.setBounds(468, 136, 133, 29);
        ...
        btnAdd.setBounds(626, 327, 89, 27);
        ...
        btnCancel.setBounds(745, 327, 88, 27);
        ...
        lblNewLabel_1 = new JLabel("ADD HOUSEHOLD");
        ...
        lblNewLabel_2.setBounds(10, 327, 124, 14);
        contentPane.add(lblNewLabel_2);
    }

    public static AddHousehold getInstance() {
        if (instance == null) {
            instance = new AddHousehold();
        }
        return instance;
    }
	...
	protected void btnAddActionPerformed(ActionEvent e) {
	    ...
	    if (TextFieldUtils.isPositiveNumberInt(textFieldMemberQuantity.getText().trim())) {
	    	...
	    	boolean isSuccess = householdDAO.addHousehold(household);
	    	if(!isSuccess) {
	    		ShowMessage.showErrorMessage("Error", "Failed to Add Household");
	    		return;
	    	}
		    ShowMessage.showMessage("Info","Household Added Successfully");
		    HouseholdManage.getInstance().refreshHouseholds();

		    var addContractForStaff = AddContractForStaff.getInstance();
		    var addContractForStaff2 = AddContractForStaff2.getInstance();
		    
		    addContractForStaff.fillData();
		    addContractForStaff.comboBoxHouseholdIdNumber.setSelectedItem(household.getIdNumber());
		    
		    addContractForStaff2.fillData();
		    addContractForStaff2.comboBoxHouseholdIdNumber.setSelectedItem(household.getIdNumber());
