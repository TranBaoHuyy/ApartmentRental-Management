...
public class UpdateContract extends JDialog {

    private static final long serialVersionUID = 1L;
    private static UpdateContract instance;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                UpdateContract frame = new UpdateContract();
	...
	public UpdateContract() {
        ...
        lblNewLabel = new JLabel("UPDATE CONTRACT FORM");
        ...
        btnAdd.setBounds(775, 443, 168, 33);
        ...
        textFieldMemberQuantity.setEditable(false);
        textFieldMemberQuantity.setColumns(10);
        textFieldMemberQuantity.setBounds(0, 30, 170, 30);
        panel_15.add(textFieldMemberQuantity);
        ...
        lblNewLabel_1.setBounds(33, 455, 124, 14);
	...
	public void loadData() {
    	...
    	Contract contract = contractDAO.getContractById(Integer.parseInt(ContractManage.getInstance().getSelectedContractId()));
    	
    	textFieldContractNumber.setText(contract.getContractNumber());

    	
    	dateChooserStartDate.setDate(contract.getStartDate());
    	dateChooserEndDate.setDate(contract.getEndDate());

    	
    	comboBoxApartmentId.setSelectedItem(contract.getApartmentId());
    	comboBoxHouseholdIdNumber.setSelectedItem(contract.getHouseholdIdNumber());
    	comboBoxStaffId.setSelectedItem(contract.getStaffId());
    	comboBoxStatus.setSelectedItem(contract.isStatus()? "Validated" : "Expired");
	...
	protected void btnAddActionPerformed(ActionEvent e) {
		...
		contract.setId(Integer.parseInt(ContractManage.getInstance().getSelectedContractId()));
		...
		ContractDAO contractDAO = new ContractDAO();
		ShowMessage.showMessage("Info", contractDAO.updateContract(contract) ? "Contract Updated Successfully" : "Failed to Update Contract");
